...
const slides: Slide[] = [
  {
    ...
    alt: "Vamana Insurance Broking corporate insurance advisory meeting with business clients in India",
  ...
  },
  {
    ...
    alt: "Construction site engineers covered by Contractor's All Risk (CAR) insurance from Vamana Insurance Broking India",
  ...
  },
  {
    ...
    alt: "Cargo containers at a shipping port covered by marine cargo and transit insurance from Vamana Insurance Broking India",
  ...
  },
  {
    ...
    alt: "Industrial machinery in a modern Indian factory protected by property, fire and industrial all-risk insurance from Vamana Insurance Broking",
  ...
  },
  {
    ...
    alt: "Vamana Insurance Broking claim settlement advisor assisting an Indian corporate client with insurance claim documentation",
